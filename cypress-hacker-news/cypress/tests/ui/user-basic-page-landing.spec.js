...
describe('User - Basic - Page - Landing', { tags: ['user-basic', 'page-landing'] }, () => {

  let userBasic = Cypress.env('USER_BASIC')
  let userBasicPass = Cypress.env('USER_BASIC_PASS')


  beforeEach('Login - User - Basic', () => {
  ...
  it('Header - Welcome - redirect', { tags: 'page-landing-003' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
    cy.contains('welcome').click()
    /** Then */
    cy.url().should('include', 'https://news.ycombinator.com/newswelcome.html')
  })

  it('Header - New - redirect', { tags: 'page-landing-004' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Past - redirect', { tags: 'page-landing-005' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Comments - redirect', { tags: 'page-landing-006' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Ask - redirect', { tags: 'page-landing-007' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Show - redirect', { tags: 'page-landing-008' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Jobs - redirect', { tags: 'page-landing-009' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Submit - redirect', { tags: 'page-landing-010' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
  ...
  it('Header - Username', { tags: 'page-landing-011' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
    /** Then */
  ...
  it('Header - Username - redirect', { tags: 'page-landing-012' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
    cy.contains(userBasic).click()
    /** Then */
    cy.url().should('include', 'https://news.ycombinator.com/user?id=' + userBasic)
    cy.get('.hnuser > font')
  })

  it('Header - Karma - count', { tags: 'page-landing-013' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
    /** Then */
    cy.get('#karma').contains(1)
  })

  it('Header - Logout', { tags: 'page-landing-014' }, () => {
    /** Given */
    cy.visit('/')
    /** When */
    /** Then */
  ...
  it('Table - Result - Title Line - vote arrow', { tags: 'page-landing-102' }, () => {
    /** Given */
    cy.visit('/')
  ...
  it('Table - Result - Sub-line - hide', { tags: 'page-landing-109' }, () => {
    /** Given */
    cy.visit('/')
    cy.getItemIdByRank('1.')
      .then((id) => {
        ...
        cy.getItemIdByRank('1.')
          .then((id) => {
            const itemId2 = id
            /** Then */
            expect(itemId2).to.not.eql(itemId)
          })
      })
  })
